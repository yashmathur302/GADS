...
return [
    ...
    'admin' => [
        ...
        [
            ...
            'children' => [
                [
                    'label' => 'Top RSA & Ad Copies',
                    'uri' => 'assets/rsa-ad-copies',
                    'route' => 'assets.rsa-ad-copies',
                    'description' => 'High-performing Responsive Search Ad copy, ready to reuse.',
                ],
                [
                    'label' => 'Audience / Intent Lists',
                    'uri' => 'assets/audience-lists',
                    'route' => 'assets.audience-lists',
                    'description' => 'Audience segments and intent lists that have performed well.',
                ],
                [
                ...
                [
                    'label' => 'Landing Page Blueprints',
                    'uri' => 'assets/landing-page-blueprints',
                    'route' => 'assets.landing-pages',
                    'description' => 'Landing page structures and blueprints that convert.',
                ],
            ],
        ],
